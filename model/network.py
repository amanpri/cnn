...
class Net:
    def __init__(self):
        ...
        lr = 0.01
        self.layers = []
        self.layers.append(Convolution2D(inputs_channel=3, num_filters=3, kernel_size=5, padding=0, stride=3, learning_rate=lr, name='conv1'))
        self.layers.append(ReLu())
        self.layers.append(Maxpooling2D(pool_size=2, stride=0, name='maxpool2'))
        self.layers.append(Convolution2D(inputs_channel=3, num_filters=3, kernel_size=5, padding=0, stride=3, learning_rate=lr, name='conv3'))
        self.layers.append(ReLu())
        self.layers.append(Maxpooling2D(pool_size=2, stride=0, name='maxpool4'))
        self.layers.append(Convolution2D(inputs_channel=3, num_filters=3, kernel_size=5, padding=0, stride=3, learning_rate=lr, name='conv5'))
        self.layers.append(ReLu())
        self.layers.append(Flatten())
        self.layers.append(FullyConnected(num_inputs=3, num_outputs=10, learning_rate=lr, name='fc6'))
        self.layers.append(ReLu())
        self.layers.append(FullyConnected(num_inputs=10, num_outputs=2, learning_rate=lr, name='fc7'))
